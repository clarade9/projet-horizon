const CHAPTERS=[
  ...
  { num:"Affaire 2",name:"Le Déjeuner de l'Acheteur",sub:"Marchés publics & Appels d'offres",dureeMin:5,
    ...
    dialogue:[
      ...
      {sp:"M. Laroche",ch:{css:"c-laroche",em:"👔",nm:"M. Laroche — GlobalTri"},sc:"resto",txt:"(Glissant son téléphone vers vous) <em>« Au fait — deux places Roland Garros, loge présidentielle, le 3 juin. Je vous les mets à votre nom, c'est plus simple. Considérez ça comme un geste d'amitié. »</em>"},
    ],
    clues:[
    ...
    pressureIntro:"Laroche vous envoie un SMS : « Les Roland Garros sont à votre nom, j'espère qu'on peut compter l'un sur l'autre. »",
    choices:[
